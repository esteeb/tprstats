...
#'
#' @param linmod The regression for which confidence intervals of coefficients are to be calculated. An object of class "lm" or one that can be coerced to that class.
